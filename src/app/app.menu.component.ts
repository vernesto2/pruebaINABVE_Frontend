...
export class AppMenuComponent implements OnInit {
    ...
    ngOnInit() {
        this.model = [
            {
                label: 'Modulos', icon: 'pi pi-home',
                items: [
                    {label: 'Persona', icon: 'pi pi-fw pi-home', routerLink: ['/dashboards'],
                        items: [
                            {label: 'Registro', icon: 'pi pi-plus', routerLink: ['/registroPersona']},
                            {label: 'Lista', icon: 'pi pi-list', routerLink: ['/listaPersona']},
                        ]
                    }
                ]
             },
